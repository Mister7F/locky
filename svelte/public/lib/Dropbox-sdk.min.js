!(function (e, t) {
    ...
    var p = 'app',
        ...
        f = 'dropboxapi.com',
        m = 'dropbox.com',
        d = { api: 'api', notify: 'bolt', content: 'api-content' },
        _ = {}
    function q(e) {
            ...
            var t =
                ...
                r =
                    arguments.length > 2 && void 0 !== arguments[2]
                        ...
                        : '.'
            return (
                t !== f && void 0 !== d[e] && ((e = d[e]), (r = '-')),
                'https://'.concat(e).concat(r).concat(t, '/2/')
            )
        },
        b = function () {
            var e =
            ...
            return (
                e !== m && (e = 'meta-'.concat(e)),
                'https://'.concat(e, '/oauth2/authorize')
            )
        },
        v = function () {
            var e =
            ...
            return (
                e !== f && ((r = d[r]), (t = '-')),
                'https://'.concat(r).concat(t).concat(e, '/oauth2/token')
            )
        }
    function k(e) {
        return JSON.stringify(e).replace(/[\u007f-\uffff]/g, q)
    }
    function y(e) {
    ...
    function F(e) {
        return e.text().then(function (t) {
            ...
            throw new M(e.status, e.headers, r)
        })
    }
    function R(e) {
        return e.ok
            ? e.text().then(function (t) {
                  ...
                  return new P(e.status, e.headers, r)
              })
            : F(e)
    }
    ;(T = C() ? window.fetch.bind(window) : require('node-fetch')),
        (L = C() ? window.crypto || window.msCrypto : require('crypto')),
        (w =
            'undefined' == typeof TextEncoder
                ? require('util').TextEncoder
                : TextEncoder)
    var D,
        G = ['legacy', 'offline', 'online'],
        U = ['code', 'token'],
        E = ['none', 'user', 'team'],
        x = (function () {
            function e(r) {
                t(this, e),
                    (this.fetch = (r = r || {}).fetch || T),
                    ...
                    (this.domainDelimiter = r.domainDelimiter)
            }
            return (
                s(e, [
                    {
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e,
                                t = this,
                                r = new w().encode(this.codeVerifier)
                            if (C())
                                return L.subtle
                                    .digest('SHA-256', r)
                                    .then(function (r) {
                            ...
                            var s = L.createHash('sha256').update(r).digest()
                            return (
                                (e = S(s)),
                                (this.codeChallenge = e),
                                Promise.resolve()
                            )
                        },
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (C()) {
                                ...
                                e = S(btoa(r)).substr(0, 128)
                            } else {
                                e = S(L.randomBytes(128)).substr(0, 128)
                            }
                            return (
                                (this.codeVerifier = e),
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            if (!U.includes(i))
                                throw Error(
                                    'Authorization type must be code or token'
                                )
                            if (n && !G.includes(n))
                                throw Error(
                            ...
                            if (!E.includes(a))
                                throw Error(
                                    'includeGrantedScopes must be none, user, or team'
                                )
                            return (
                                (r =
                                    'code' === i
                                ...
                                'none' !== a &&
                                    (r += '&include_granted_scopes='.concat(a)),
                                o
                                    ? this.generatePKCECodes().then(
                                          function () {
                                              return (
                                                  (r +=
                                                      '&code_challenge_method=S256'),
                                                  (r +=
                                                      '&code_challenge='.concat(
                                                          s.codeChallenge
                                                      ))
                                              )
                                          }
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            ...
                            var i = v(this.domain, this.domainDelimiter)
                            if (
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this,
                                t =
                                    ...
                                    void 0 !== arguments[0]
                                        ? arguments[0]
                                        : null,
                                r = v(this.domain, this.domainDelimiter),
                                s = this.getClientId(),
                            ...
                            ;(r +=
                                '?grant_type=refresh_token&refresh_token='.concat(
                                    this.getRefreshToken()
                                )),
                                ...
                                this.fetch(r, u)
                                    ...
                                    .then(function (t) {
                                        e.setAccessToken(t.result.access_token),
                                            e.setAccessTokenExpiresAt(
                                                y(t.result.expires_in)
                                            )
                                    })
                            )
                        },
    ...
    ;(e.Dropbox = (function () {
        function e(r) {
            t(this, e),
                (this.auth = (r = r || {}).auth ? r.auth : new x(r)),
                (this.fetch = r.fetch || D),
                (this.selectUser = r.selectUser),
                (this.selectAdmin = r.selectAdmin),
                (this.pathRoot = r.pathRoot),
                (this.domain = r.domain),
                (this.domainDelimiter = r.domainDelimiter),
                (this.customHeaders = r.customHeaders),
            ...
            s(e, [
                {
                    ...
                    value: function (e, t, r, s, i) {
                        if (r.split(',').length > 1) {
                            var n = r.replace(' ', '').split(',')
                            n.includes(l) && this.auth.getAccessToken()
                                ? (r = l)
                                : n.includes(h) && this.auth.getAccessToken()
                                  ? (r = h)
                                  : n.includes(p) && (r = p)
                        }
                        switch (i) {
                ...
                },
                {
                    ...
                    value: function (e, t, r, s) {
                        ...
                        return this.auth
                            ...
                            .then(function (t) {
                                return i.fetch(
                                    g(s, i.domain, i.domainDelimiter) + e,
                                    t
                                )
                            })
                            .then(function (e) {
                ...
                },
                {
                    ...
                    value: function (e) {
                        var t = this
                        ;(this.selectUser &&
                            (e.headers['Dropbox-API-Select-User'] =
                                this.selectUser),
                        this.selectAdmin &&
                            (e.headers['Dropbox-API-Select-Admin'] =
                                this.selectAdmin),
                        this.pathRoot &&
                            (e.headers['Dropbox-API-Path-Root'] =
                                this.pathRoot),
                        this.customHeaders) &&
                            Object.keys(this.customHeaders).forEach(
                                function (r) {

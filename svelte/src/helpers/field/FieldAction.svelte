                ...
                <Icon color="on-surface">
                    <svg
                        ...
                        <path
                            ...
                            0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z"></path>
                    </svg>
                </Icon>
            </Item>
                ...
                <Icon color="on-surface">
                    <svg
                        ...
                        <path
                            ...
                            0l-1.83 1.83 3.75 3.75 1.83-1.83z"></path>
                        <path d="M0 0h24v24H0z" fill="none"></path>
                    </svg>
                </Icon>
            </Item>
                ...
                <Icon color="on-surface">
                    <svg
                        ...
                        <path
                            ...
                            9h8v10H8V9zm7.5-5l-1-1h-5l-1 1H5v2h14V4z"></path>
                    </svg>
                </Icon>
            </Item>
        </List>
